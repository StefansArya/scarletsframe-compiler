...
exports.scarletsFrameVirtualRegion = void 0;
function scarletsFrameVirtualRegion(documentText, position) {
    let emptySpaces = documentText.split('\n');
    let charLength = 0;
    let posLineLength = 0;
...
exports.scarletsFrameVirtualRegion = scarletsFrameVirtualRegion;
